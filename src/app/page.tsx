  ...
  return (
    <div className="bg-white">
      ...
      <section className="mx-auto max-w-4xl px-6 pb-24 pt-20 text-center">
        ...
        {/* SPA/JS compatibility trust badge */}
        <div className="mt-3 inline-flex items-center gap-2 rounded-full border border-amber-200 bg-amber-50 px-4 py-2 text-sm text-amber-900 shadow-sm">
          <svg className="h-4 w-4 text-amber-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5" />
          </svg>
          <span className="font-semibold">Works with SPAs &amp; JS-heavy sites</span>
          <span className="text-amber-400">·</span>
          <span className="text-amber-800">React, Vue, Next.js, Webflow</span>
        </div>
      </section>
      ...
      <section id="features" className="border-t border-gray-100 bg-gray-50 py-24">
        <div className="mx-auto max-w-6xl px-6">
          ...
          {/* "Zero noise, curated alerts" callout — A/B: quantified noise claim experiment (ticket 3925) */}
          <div className="mt-4 flex justify-center">
            <QuantifiedNoiseClaim />
          </div>
      ...
      <section className="border-t border-gray-100 py-24">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <p className="mt-6 text-center text-sm text-gray-500">
            Email, Slack, and Webhooks are live today. Microsoft Teams works via webhook URL. Zapier integration coming soon.
          </p>
        </div>
      </section>
