...
export default function CompareKompWatchVsHeadsUpPage() {
  return (
    <div className="bg-white">
      ...
      <RelatedComparisons
        current="kompwatch-vs-headsup"
        intro="Comparison-shopping AI competitor tools? Here's how KompWatch stacks up against the enterprise CI platforms teams evaluate alongside HeadsUp."
      />
