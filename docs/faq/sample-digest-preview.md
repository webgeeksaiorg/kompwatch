...
The sample digest is built from a realistic monitoring scenario — three SaaS competitors tracked over a week. It includes:

- **Pricing change** — a competitor quietly removed a plan tier
