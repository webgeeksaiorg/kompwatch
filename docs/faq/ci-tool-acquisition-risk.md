...
If you're a Kompyte customer, see [For Semrush/Kompyte Users →](./for-semrush-users.md) and [Switching from Kompyte →](./switching-from-kompyte.md) for a step-by-step migration guide.
...
KompWatch was built specifically for the SMB market that enterprise CI tools priced out or outgrew. Self-serve signup, free tier, $49/mo Pro plan, monthly billing, no sales call required. See [Is KompWatch Right for My Team?](./is-kompwatch-right-for-my-team.md) for an honest breakdown.
...
3. **Import your competitor list** — we can help with bulk setup for teams migrating from Crayon, Klue, or Kompyte; email [support@kompwatch.com](mailto:support@kompwatch.com) with your current tracked URL list
...
- [Switching from Kompyte](./switching-from-kompyte.md)
- [Switching from Klue](./switching-from-klue.md)
- [For Semrush/Kompyte Users](./for-semrush-users.md)
- [Is KompWatch Right for My Team?](./is-kompwatch-right-for-my-team.md)
- [Comparing KompWatch to Alternatives](./comparing-to-alternatives.md)

---

*Questions about migration? Email [support@kompwatch.com](mailto:support@kompwatch.com) — we respond within 24 hours.*
