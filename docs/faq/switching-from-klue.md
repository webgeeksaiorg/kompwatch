...
- **Ignition acquisition and shutdown** — Klue acquired Ignition (agentic AI for product marketers) in September 2025 — IP only, no employees — and shut it down within 28 days. Ignition customers were given a 30-day wind-down notice. If you came from Ignition, see [Switching from Ignition →](./switching-from-ignition.md).
- **Layoffs and product pivot** — Klue cut approximately 85 employees (40% of staff) in 2025, then laid off another ~100 employees in May 2026 (roughly a third of their remaining team), citing a "focus on AI." Their CEO acknowledged they were losing deals to ChatGPT — a signal that a significant portion of their customer value was in the "summarize what a competitor does" layer, which LLMs now provide for free. The bet is now on AI-restructured workflows and Microsoft/Teams integration rather than monitoring depth. Two significant layoff rounds in under 18 months is worth factoring into a renewal decision.
