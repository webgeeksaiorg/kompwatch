...
For hiring signal interpretation, see [Reading Competitor Job Listing Signals](./reading-competitor-job-listing-signals.md).
...
1. Go to [kompwatch.com/competitors](https://kompwatch.com/competitors) and open a key competitor
2. Set the date filter to your review period (e.g., last quarter)
3. Filter to **High and Critical** changes
4. Export via **Settings → Export → CSV** — you get a timestamped record of what changed and when
...
- **Shared `#competitive-intel` Slack channel** with High+ severity auto-posting — you see it if it surfaces, but don't need to check
- **Your own weekly email** covering the full change history for all tracked competitors, filtered to High/Critical

See [Integrations and Notifications](./integrations-and-notifications.md) for Slack setup.
